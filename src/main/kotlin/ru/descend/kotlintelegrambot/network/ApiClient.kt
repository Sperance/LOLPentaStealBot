package ru.descend.kotlintelegrambot.network

import ru.descend.kotlintelegrambot.entities.BotCommand
import ru.descend.kotlintelegrambot.entities.Chat
import ru.descend.kotlintelegrambot.entities.ChatAction
import ru.descend.kotlintelegrambot.entities.ChatId
import ru.descend.kotlintelegrambot.entities.ChatMember
import ru.descend.kotlintelegrambot.entities.ChatPermissions
import ru.descend.kotlintelegrambot.entities.InlineKeyboardMarkup
import ru.descend.kotlintelegrambot.entities.Message
import ru.descend.kotlintelegrambot.entities.MessageEntity
import ru.descend.kotlintelegrambot.entities.MessageId
import ru.descend.kotlintelegrambot.entities.ParseMode
import ru.descend.kotlintelegrambot.entities.ReplyMarkup
import ru.descend.kotlintelegrambot.entities.SentWebAppMessage
...
import ru.descend.kotlintelegrambot.entities.UserProfilePhotos
import ru.descend.kotlintelegrambot.entities.WebhookInfo
import ru.descend.kotlintelegrambot.entities.dice.DiceEmoji
import ru.descend.kotlintelegrambot.entities.files.File
...
import ru.descend.kotlintelegrambot.entities.payments.LabeledPrice
import ru.descend.kotlintelegrambot.entities.payments.ShippingOption
import ru.descend.kotlintelegrambot.entities.polls.Poll
import ru.descend.kotlintelegrambot.entities.polls.PollType
import ru.descend.kotlintelegrambot.entities.reaction.ReactionType
import ru.descend.kotlintelegrambot.entities.stickers.MaskPosition
import ru.descend.kotlintelegrambot.entities.stickers.StickerSet
import ru.descend.kotlintelegrambot.network.MediaTypeConstants.AUDIO_OGG
import ru.descend.kotlintelegrambot.network.multipart.MultipartBodyFactory
import ru.descend.kotlintelegrambot.network.multipart.toMultipartBodyPart
import ru.descend.kotlintelegrambot.network.retrofit.converters.ChatIdConverterFactory
import ru.descend.kotlintelegrambot.network.retrofit.converters.DiceEmojiConverterFactory
import ru.descend.kotlintelegrambot.network.retrofit.converters.EnumRetrofitConverterFactory
import ru.descend.kotlintelegrambot.network.retrofit.converters.InputMediaConverterFactory
import ru.descend.kotlintelegrambot.network.serialization.GsonFactory
