...
internal fun String.toMultipartBodyPart(partName: String) = MultipartBody.Part.createFormData(partName, this)

internal fun <T> T.toMultipartBodyPart(partName: String) = toString().toMultipartBodyPart(partName)

internal fun Iterable<String>.toMultipartBodyPart(partName: String) = joinToString(separator = ",", prefix = "[", postfix = "]").toMultipartBodyPart(partName)
...
internal fun ByteArray.toMultipartBodyPart(
    ...
    val requestBody = this.toRequestBody(mimeType, 0, this.size)
