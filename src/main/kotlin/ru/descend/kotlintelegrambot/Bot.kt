...
import ru.descend.kotlintelegrambot.constants.TOKEN
...
import ru.descend.kotlintelegrambot.entities.payments.PaymentInvoiceInfo
...
import ru.descend.kotlintelegrambot.network.bimap
import ru.descend.kotlintelegrambot.network.call
...
import ru.descend.kotlintelegrambot.updater.CoroutineLooper
import ru.descend.kotlintelegrambot.updater.Updater
import ru.descend.kotlintelegrambot.webhook.WebhookConfig
import ru.descend.kotlintelegrambot.webhook.WebhookConfigBuilder
...
class Bot private constructor(
    ...
    class Builder {
        ...
        fun build(): Bot {
            ...
            val apiClient = ApiClient(token, apiUrl, timeout, proxy, gson, httpClientInterceptors = httpClientInterceptors)
